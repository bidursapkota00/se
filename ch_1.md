...
Systematic, disciplined, quantifiable approach to the development, operation, and maintenance of software to produce reliable, efficient, and maintainable software within time and budget constraints.
...
- **Process Models** — define _how_ software is developed (e.g., Waterfall, Agile, Spiral).
- **System/Analysis Models** — represent _what_ the software does or _how_ it is structured (e.g., use case diagrams, class diagrams, data flow diagrams).
...
**Task:** A smaller, well-defined unit of work within an activity. For example, within "Testing," tasks include _write test cases_, _execute regression tests_, _log defects_.
